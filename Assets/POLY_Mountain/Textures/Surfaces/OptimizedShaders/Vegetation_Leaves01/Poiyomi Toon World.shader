Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/03a8ac9b900a61f4ba89019ca0467709"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyShadeMapping(inout PoiFragData poiFragData, PoiMesh poiMesh, inout PoiLight poiLight)
			{
				...
				#endif
				float MainColorFeatherStep = (1.0 /*_BaseColor_Step*/) - (0.0001 /*_BaseShade_Feather*/);
				...
				firstShadeMap.rgb *= float4(0.234375,0.267082,0.3,1).rgb; //* lighColor
				...
				float mainShadowMask = saturate(1 - ((poiLight.lightMap) - MainColorFeatherStep) / ((1.0 /*_BaseColor_Step*/) - MainColorFeatherStep) * (shadowMask));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.2941177,0.4705882,0.6,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.2941177,0.4705882,0.6,1).a;
