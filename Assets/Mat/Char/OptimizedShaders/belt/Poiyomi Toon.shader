Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/9b3242335f6034f448be7fd2a6760fc5"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyShadeMapping(inout PoiFragData poiFragData, PoiMesh poiMesh, inout PoiLight poiLight)
			{
				...
				#endif
				float MainColorFeatherStep = (0.66 /*_BaseColor_Step*/) - (0.318 /*_BaseShade_Feather*/);
				...
				firstShadeMap.rgb *= float4(0.2830189,0.2830189,0.2830189,1).rgb; //* lighColor
				...
				float mainShadowMask = saturate(1 - ((poiLight.lightMap) - MainColorFeatherStep) / ((0.66 /*_BaseColor_Step*/) - MainColorFeatherStep) * (shadowMask));
