Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/d2ca7b71a0fb71c4588cf5f58e0fc503"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				float lineWidth = (0.03 /*_LineWidth*/);
				#ifdef POI_AUDIOLINK
			...
			void applyShadeMapping(inout PoiFragData poiFragData, PoiMesh poiMesh, inout PoiLight poiLight)
			{
				...
				#endif
				float MainColorFeatherStep = (0.791 /*_BaseColor_Step*/) - (0.021 /*_BaseShade_Feather*/);
				float firstColorFeatherStep = (0.0 /*_ShadeColor_Step*/) - (1.0 /*_1st2nd_Shades_Feather*/);
				#if defined(PROP_1ST_SHADEMAP) || !defined(OPTIMIZER_ENABLED)
				...
				firstShadeMap.rgb *= float4(0,0,0,1).rgb; //* lighColor
				secondShadeMap.rgb *= float4(0.6981132,0.6981132,0.6981132,1).rgb; //* LightColor;
				float shadowMask = 1;
				...
				float mainShadowMask = saturate(1 - ((poiLight.lightMap) - MainColorFeatherStep) / ((0.791 /*_BaseColor_Step*/) - MainColorFeatherStep) * (shadowMask));
				...
				mainShadowMask *= poiLight.shadowMask * (0.325 /*_ShadowStrength*/);
				firstSecondShadowMask *= poiLight.shadowMask * (0.325 /*_ShadowStrength*/);
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				#endif
				float shadowStrength = (0.325 /*_ShadowStrength*/) * poiLight.shadowMask;
				#ifdef POI_PASS_OUTLINE
