Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/6aa2608b3c61a2a4980656b31b4cb754"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				{
					distanceOffset *= lerp(1.0, clamp((distance(_WorldSpaceCameraPos, mul(unity_ObjectToWorld, o.localPos).xyz)), 0.0f, (4.64 /*_OutlinesMaxDistance*/)), (0.0 /*_OutlineFixWidth*/));
				}
				float lineWidth = (0.015 /*_LineWidth*/);
				#ifdef POI_AUDIOLINK
			...
			void applyShadeMapping(inout PoiFragData poiFragData, PoiMesh poiMesh, inout PoiLight poiLight)
			{
				...
				#endif
				float MainColorFeatherStep = (0.763 /*_BaseColor_Step*/) - (0.318 /*_BaseShade_Feather*/);
				float firstColorFeatherStep = (0.319 /*_ShadeColor_Step*/) - (1.0 /*_1st2nd_Shades_Feather*/);
				#if defined(PROP_1ST_SHADEMAP) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				firstShadeMap = lerp(firstShadeMap, float4(poiFragData.baseColor, 1), (0.0 /*_Use_BaseAs1st*/));
				#if defined(PROP_2ND_SHADEMAP) || !defined(OPTIMIZER_ENABLED)
				...
				firstShadeMap.rgb *= float4(0.4811321,0.4811321,0.4811321,1).rgb; //* lighColor
				...
				float mainShadowMask = saturate(1 - ((poiLight.lightMap) - MainColorFeatherStep) / ((0.763 /*_BaseColor_Step*/) - MainColorFeatherStep) * (shadowMask));
				float firstSecondShadowMask = saturate(1 - ((poiLight.lightMap) - firstColorFeatherStep) / ((0.319 /*_ShadeColor_Step*/) - firstColorFeatherStep) * (shadowMask));
				mainShadowMask *= poiLight.shadowMask * (1.0 /*_ShadowStrength*/);
				firstSecondShadowMask *= poiLight.shadowMask * (1.0 /*_ShadowStrength*/);
				if ((1.0 /*_ShadingShadeMapBlendType*/) == 0)
				{
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = (0.15 /*_EmissionStrength*/);
				...
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0.4910209,0.6307573,0.2086369,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0.4910209,0.6307573,0.2086369,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0.4910209,0.6307573,0.2086369,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				#endif
			...
			{
				float clearCoatMask = (0.911 /*_ClearCoatStrength*/);
				float smoothness = (0.085 /*_ClearCoatSmoothness*/);
				float reflectionMask = (1.0 /*_ClearCoatReflectionStrength*/);
				float specularMask = (0.777 /*_ClearCoatSpecularStrength*/);
				#if defined(PROP_CLEARCOATMAPS) || !defined(OPTIMIZER_ENABLED)
				...
				specular = poiLight.directColor * specularTerm * fresnelTerm * specularMask * poiThemeColor(poiMods, float4(0.8490566,0.8490566,0.8490566,1), (0.0 /*_ClearCoatSpecularTintThemeIndex*/)) * poiLight.occlusion * attenuation;
				if (poiFragData.toggleVertexLights)
				{
					#if defined(VERTEXLIGHT_ON)
					for (int index = 0; index < 4; index++)
					{
						...
						vSpecular += poiLight.vColor[index] * specularTerm * fresnelTerm * specularMask * poiThemeColor(poiMods, float4(0.8490566,0.8490566,0.8490566,1), (0.0 /*_ClearCoatSpecularTintThemeIndex*/)) * poiLight.occlusion;
					}
					#endif
				}
				...
				reflections *= poiThemeColor(poiMods, float4(0.4245283,0.4245283,0.4245283,1), (0.0 /*_ClearCoatReflectionTintThemeIndex*/)) * reflectionMask;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.7294118,0.8156863,0.4941177,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.7294118,0.8156863,0.4941177,1).a;
