Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/1ae7bb049970ec443932c40eb98b39e9"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyShadeMapping(inout PoiFragData poiFragData, PoiMesh poiMesh, inout PoiLight poiLight)
			{
				...
				secondShadeMap.rgb *= float4(0,0,0,1).rgb; //* LightColor;
				float shadowMask = 1;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.5283019,0.3235256,0.01196154,0.9490196).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.5283019,0.3235256,0.01196154,0.9490196).a;
